...
#import "MXVNavigationBarView.h"
#import <Masonry.h>

@interface MXVNavigationBarView()

@end

@implementation MXVNavigationBarView
...
// 初始化配置
- (void)configInit {  
    self.frame = CGRectMake(0, 0, mxwScreenWidth(), mxwStatusNavBarHeight());
    ...
    [statusBarView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.equalTo(@(mxwStatusHeight()));
    }];
