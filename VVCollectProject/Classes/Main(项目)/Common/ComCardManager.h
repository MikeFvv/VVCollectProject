...
typedef NS_ENUM(NSInteger, CardType) {
    CardType_HIGH_CARD,          //高牌
    CardType_ONE_PAIR,           //一对
    CardType_TWO_PAIR,           //二对
    CardType_THREE_OF_A_KIND,    //三条
    CardType_STRAIGHT,           //顺子
    CardType_FLUSH,              //同花
    CardType_FULL_HOUSE,         //葫芦
    CardType_FOUR_OF_A_KIND,     //四条
    CardType_STRAIGHT_FLUSH,     //同花顺
};
