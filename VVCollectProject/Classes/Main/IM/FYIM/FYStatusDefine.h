...
#pragma mark FYSDKRunningMode - SDK当前所处的状态
/*!
 SDK当前所处的状态
 */
typedef NS_ENUM(NSUInteger, FYSDKRunningMode) {
    /*!
     后台运行状态
     */
    FYSDKRunningMode_Background = 0,

    /*!
     前台运行状态
     */
    FYSDKRunningMode_Foreground = 1
};
...
/*!
 会话类型
 */
typedef NS_ENUM(NSUInteger, FYConversationType) {
    /*!
     单聊
     */
