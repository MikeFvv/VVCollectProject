...
@property (weak, nonatomic) MXWTimer *timer;

@property (weak, nonatomic) MXWTimer *autoTimer;
...
- (IBAction)start:(UIButton *)sender {
    ...
    // 风格一:
    self.timer = [MXWTimer timeInterval:1.0 totalInterval:10 isStart:NO change:^(NSTimeInterval interval) {
...
//    }];
    ...
    // 风格三:
    [MXWTimer timeInterval:1.0 change:^(NSTimeInterval interval) {
