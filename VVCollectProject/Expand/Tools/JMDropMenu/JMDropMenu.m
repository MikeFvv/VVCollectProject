...
- (void)layoutSubviews {
    ...
    if (self.model.layoutType == JMDropMenuLayoutTypeTitle) {
        ...
        self.titleL.frame = CGRectMake(CGRectGetMaxX(self.imageIV.frame) + 10, self.screenCenter - 10, self.frame.size.width - 50, 20);
    }
    self.line1.frame = CGRectMake(0, self.frame.size.height - 0.5, self.frame.size.width, 0.5);
}
